...
print '&lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot; onclick=&quot;history.back()&quot;&gt;前のページに戻る&lt;/button&gt;';
	...
	print '<a href="session_out.php"><button type="button" class="btn btn-info">セッションの破棄</button></a><br>';
...
?&gt;
	...
	print '<p class="text-danger">何度か更新を行い動作を確認してください。セッションIDが削除されては作られて、で動作が変わります。</p>';
