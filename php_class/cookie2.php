...
print &quot;&lt;p&gt;&quot;.\$_COOKIE['username'].&quot;&lt;/p&gt;&quot;;
	...
	print '<h2 class="bg-success">少し前の時刻を指定してクッキーを破棄する。</h2>';

	setcookie('username', 'michele', time() - 1);
	print "<p>" . $_COOKIE['username'] . "</p>";
	print "<p>結果的に\$_COOKIEを表示しようとするとエラーメッセージが表示されます。</p>";
